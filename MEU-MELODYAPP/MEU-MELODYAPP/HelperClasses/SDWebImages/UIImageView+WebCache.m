...
- (void)sd_setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock
{
   ...
   // self.image = placeholder;
    ...
    UIActivityIndicatorView *activityIndicatorVw = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
    [activityIndicatorVw setFrame:CGRectMake(self.frame.size.width/2-18, self.frame.size.height/2-17, 37, 37)];
    
    [activityIndicatorVw hidesWhenStopped];
    
    if (placeholder == nil) {
        
        [self addSubview:activityIndicatorVw];
            ...
            dispatch_main_sync_safe(^{
                ...
                if (image) {
                   // wself.image = image;
                    ...
                    [activityIndicatorVw removeFromSuperview];
                    
                    wself.image = [CommonFunctions scaleDownSizeOfImage:image Size:CGSizeMake(self.frame.size.width, self.frame.size.height)];
